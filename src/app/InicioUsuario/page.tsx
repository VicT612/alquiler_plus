...
const AboutRoom = () => {
  ...
  return (
    <div className={`flex h-screen ${sidebarOpen ? 'bg-gray-100 dark:bg-gray-900' : ''}`}>
      <div
        className={`h-full p-3 space-y-2 w-60 bg-white dark:bg-gray-800 ${sidebarOpen ? 'block' : 'hidden'} lg:block`}
      >
        {user && (
      ...
      <div className="flex-1 p-6">
        <header className="flex items-center justify-between mb-6 bg-white dark:bg-gray-800">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-current dark:text-gray-300">
        ...
        <main className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          {selectedView === 'cuartos' && cuartos.map((cuarto) => (
          ...
          {selectedView === 'cuarto' && (
            <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
              {/* Aquí puedes poner el contenido de la vista de cuarto */}
              <h2>Vista de Cuarto</h2>
            </div>
          )}
          {selectedView === 'chat' && (
            <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
              {/* Aquí puedes poner el contenido de la vista de chat */}
              <h2>Vista de Chat</h2>
            </div>
          )}
          {selectedView === 'wishlist' && (
            <div className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
              {/* Aquí puedes poner el contenido de la vista de lista de deseos */}
              <h2>Vista de Lista de Deseos</h2>
            </div>
          )}
        </main>
      </div>
